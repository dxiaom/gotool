...
if [ ! -t 0 ]; then
    ...
    sudo curl -fL "https://gh-proxy.com/https://raw.githubusercontent.com/dxiaom/gotool/main/install.sh" -o "$TOOL_PATH" || {
...
# 获取最新版本信息
get_latest_version() {
    local script=$(curl -s "https://gh-proxy.com/https://raw.githubusercontent.com/dxiaom/gotool/main/install.sh")
